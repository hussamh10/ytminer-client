...
@click.option("--delay", default=5.0, help="Base delay between downloads in seconds (default: 5)")
@click.option("--jitter", default=3.0, help="Random jitter added to delay in seconds (default: 3)")
